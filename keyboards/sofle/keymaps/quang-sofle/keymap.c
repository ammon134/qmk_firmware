 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *           | LGUI | LAlt | LCTR |LOWER | / SFTENT /       \Space \  |RAISE  | RCTR | RAlt | RGUI |
 *           |      |      |      |(Space)|/       /         \      \ |(Enter)|      |      |      |
 *            `----------------------------------'            '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_QUES,  KC_RSFT,
KC_LGUI,KC_LALT,KC_LCTL, MT(MOD_LSFT, KC_SPC), LT(_LOWER,KC_ENT),     MO(_RAISE), MT(MOD_LSFT, KC_BSPC), KC_RCTL, TO(_LOWER), TO(_RAISE)
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_COLEMAK] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,      XXXXXXX,KC_K,    KC_H, KC_COMM,  KC_DOT, KC_QUES,  KC_RSFT,
KC_LGUI,KC_LALT,KC_LCTL, LT(_LOWER,KC_SPC), MT(MOD_LSFT, KC_ENT),     MO(_RAISE), MT(MOD_LSFT, KC_BSPC), KC_RCTL, TO(_LOWER), TO(_RAISE)
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
