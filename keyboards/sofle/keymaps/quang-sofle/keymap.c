...
MT(MOD_LCTL|MOD_LSFT,KC_TAB), KC_Q,   KC_W,     KC_E,   KC_R,    KC_T,                     KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     TO(_LOWER),
        MT(MOD_LGUI, KC_ESC), KC_A,   KC_S,     KC_D,   KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,
                    KC_LSFT,  KC_Z,   KC_X,     KC_C,   KC_V,    KC_B, KC_MUTE,   XXXXXXX, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
GUI_T(KC_LEFT),ALT_T(KC_RGHT),CTL_T(KC_MINUS), LT(_LOWER, KC_SPC), LT(_RAISE, KC_ENT),     MO(_RAISE), MT(MOD_RSFT, KC_BSPC), RCTL_T(KC_EQUAL), ALT_T(KC_UP), GUI_T(KC_DOWN)
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_COLEMAK] = LAYOUT(
                    KC_GRV,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_BSPC,
MT(MOD_LCTL|MOD_LSFT,KC_TAB), KC_Q,   KC_W,    KC_F,    KC_P,    KC_B,                      KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN,  TO(_LOWER),
...
[_RAISE] = LAYOUT(
    ...
    _______, XXXXXXX, A(KC_SPC), C(KC_SPC),  XXXXXXX,  XXXXXXX,                          A(KC_UP),    KC_PRVWD,   KC_UP,   KC_NXTWD, A(KC_BSPC),  TO(_ADJUST),
    TO(0)  , C(KC_A), KC_LCTL,   KC_LSFT,    KC_LALT,  KC_CAPS,                          A(KC_DOWN),  KC_LEFT,    KC_DOWN, KC_RGHT,  XXXXXXX,     KC_BSPC,
